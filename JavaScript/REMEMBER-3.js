...
// addEventListener :- The addEventListener() method is used to attach an event handler to a particular HTML element. 
...
//callback :- callback function passed as an argument to another function, to be executed after the first function completes.
...
//             जावास्क्रिप्ट प्रॉमिस का उपयोग multiple प्रबंधन को सरल बनाने के लिए किया जाता है
...
//          एसिंक फ़ंक्शन हमें वादा-आधारित कोड लिखने की अनुमति देता है जैसे कि यह सिंक्रोनस था।
